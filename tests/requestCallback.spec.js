...
// Test: Request a Call-Back Form – End-to-End Flow
//
// Author  : [Your Name]
// Stack   : Node.js · Playwright
// Target  : https://test.netlify.app/
// =============================================================================
...
test.describe('Jones – Request a Call-Back Form', () => {
  ...
  test('should fill the form, change employee count, screenshot, submit and land on thank-you page', async ({ page }) => {
    ...
    //
    // Locator strategy: getByLabel() is preferred over CSS selectors because
    // it is resilient to DOM restructuring and mirrors how real users find
    ...
    // -------------------------------------------------------------------------
    // STEP 3 (BONUS) – Change "Number of Employees" dropdown from "1-10"
    //                  to "51-500"
    //
    // selectOption() works against both the visible label text and the
    ...
    //
    // getByRole() with the accessible name is the most semantically correct
    // way to locate a button – it is unaffected by styling changes.
    // -------------------------------------------------------------------------
